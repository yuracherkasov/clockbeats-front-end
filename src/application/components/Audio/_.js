...
{/*<input type="file" placeholder="Choose file" onChange={(event) => this.fileHandler(event.target.files[0])} />*/}




{/*<Waveform onReady={() => console.log('Waveform ready!')} sample={this.state.samples} />*/}
